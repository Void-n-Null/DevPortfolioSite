...
export const developerJourney: JourneyEntry[] = [
  {
    id: "scratch-start",
    content: `I got my start with Scratch around age 11 (2014). Nothing fancy, just dragging blocks around trying to make a clone of "Cookie Clicker" that didn't suck. I spent way too many hours on it, but that's where I learned programming fundamentals.`,
    layout: "full",
    links: [
      {
        text: "Scratch",
